...
export async function bootstrapDatabase(): Promise<{ ok: boolean; steps: string[]; error?: string }> {
  ...
  try {
    ...
    if (filieres.length === 0) {
      const defs = [
        { icone: "🔌", titre: "Électricien", description: "Installation et maintenance des systèmes électriques résidentiels et industriels.", dureeHeures: "3 mois", metiers: ["Électricien bâtiment", "Électricien industriel", "Installateur de panneaux solaires", "Technicien en câblage réseau"] },
        { icone: "🔧", titre: "Plombier", description: "Installation et réparation des systèmes de plomberie et de chauffage.", dureeHeures: "3 mois", metiers: ["Plombier sanitaire", "Installateur thermique", "Chauffagiste", "Technicien CVC"] },
        { icone: "🪚", titre: "Menuisier", description: "Travail du bois : meubles, agencements et structures.", dureeHeures: "3 mois", metiers: ["Menuisier agenceur", "Ébéniste", "Charpentier bois", "Poseur de parquet"] },
        { icone: "🏗️", titre: "Maçon", description: "Construction, rénovation et gros œuvre du bâtiment.", dureeHeures: "3 mois", metiers: ["Maçon", "Carreleur", "Plâtrier-plaquiste", "Façadier"] },
        { icone: "🍳", titre: "Cuisinier", description: "Arts culinaires, restauration collective et gastronomie.", dureeHeures: "3 mois", metiers: ["Cuisinier", "Commis de cuisine", "Pizzaiolo", "Chef de partie"] },
        { icone: "👩‍⚕️", titre: "Aide-soignant", description: "Accompagnement et soins aux personnes âgées et dépendantes.", dureeHeures: "3 mois", metiers: ["Aide-soignant à domicile", "Auxiliaire de vie", "Accompagnant éducatif", "Assistant en gériatrie"] },
      ];
